                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('12',style: kTextStyle.copyWith(color: kMainColor,fontSize: 18.0,fontWeight: FontWeight.bold),),
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('1',style: kTextStyle.copyWith(color: kAlertColor,fontSize: 18.0,fontWeight: FontWeight.bold),),
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('2',style: kTextStyle.copyWith(color: const Color(0xFF4CE364),fontSize: 18.0,fontWeight: FontWeight.bold),),
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('6',style: kTextStyle.copyWith(color: kHalfDay,fontSize: 18.0,fontWeight: FontWeight.bold),),
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('1',style: kTextStyle.copyWith(color: const Color(0xFF806DF0),fontSize: 18.0,fontWeight: FontWeight.bold),),
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('3',style: kTextStyle.copyWith(color: const Color(0xFF4ACDF9),fontSize: 18.0,fontWeight: FontWeight.bold),),
                  ...
                  Row(
                    children: [
                      Expanded(child: Container(
                        ...
                        child: Center(child: Text('Delete',style: kTextStyle.copyWith(color: Colors.white,fontWeight: FontWeight.bold),)),
                      ),),
                      const SizedBox(
                        width: 20.0,
                      ),
                      Expanded(child: Container(
                        ...
                        child: Center(child: Text('Edit',style: kTextStyle.copyWith(fontWeight: FontWeight.bold),)),
                      ),),
                    ],
                  ),
                ],
